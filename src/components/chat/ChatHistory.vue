<template>
  <el-drawer title="Chat History" size="700px" :visible.sync="visible" direction="rtl" :before-close="onClose">
...
export default {
  ...
  methods: {
    ...
    onScroll() {
      let high = this.$refs.scrollbar.$refs.wrap.scrollTop; // Distance from the top
    ...
    refreshScrollPos() {
      ...
      this.$nextTick(() => {
        ...
        // If the scrollbar is not visible, continue loading
