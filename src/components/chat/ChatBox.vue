  ...
  <div class="chat-box" @click="closeRefBox()" @mousemove="readedMessage()">
    <el-container>
      <el-header height="60px">
        <span>{{title}}</span>
        <span title="Group Chat Information" v-show="this.chat.type=='GROUP'" class="btn-side el-icon-more"
          ...
          <el-container class="content-box">
            ...
            <el-footer height="240px" class="im-chat-footer">
              <div class="chat-tool-bar">
                <div title="Emoticon" class="icon iconfont icon-biaoqing" ref="emotion"
                ...
                <div title="Send Voice" class="el-icon-microphone" @click="showVoiceBox()">
                </div>
                <div title="Video Chat" v-show="chat.type=='PRIVATE'" class="el-icon-phone-outline"
                     @click="showVideoBox()">
                </div>
              ...
              <div class="send-content-area">
                <div contenteditable="true" v-show="!sendImageUrl" ref="editBox" class="send-text-area"
                     ...
                     placeholder="Friendly reminder: You can paste screenshots here~" @blur="onEditBoxBlur()" @keydown.down="onKeyDown"
                ...
                <div v-show="sendImageUrl" class="send-image-area">
                  <div class="send-image-box">
                    ...
                    <span class="send-image-close el-icon-close" title="Delete"
