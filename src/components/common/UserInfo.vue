  ...
  <div class="user-info-mask" @click="$emit('close')">
    <div class="user-info" :style="{left: pos.x+'px',top: pos.y+'px'}" @click.stop>
      <div class="user-info-box">
        ...
        <div>
          <el-descriptions :column="1" :title="user.userName" class="user-info-items">
            <el-descriptions-item label="Nickname">{{ user.nickName }}
            </el-descriptions-item>
            <el-descriptions-item label="Signature">{{ user.signature }}
            </el-descriptions-item>
          </el-descriptions>
        </div>
      ...
      <div class="user-btn-group">
        <el-button v-show="isFriend" type="primary" @click="onSendMessage()">Send Message</el-button>
        <el-button v-show="!isFriend" type="primary" @click="onAddFriend()">Add as Friend</el-button>
      </div>
    </div>
  </div>
</template>
